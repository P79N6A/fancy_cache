...
import pers.fancy.tools.script.ScriptExecutor;
import pers.fancy.tools.trace.tlog.TlogFilter.TLogContext;
...
import static pers.fancy.tools.trace.tlog.TlogConstants.LOGGER_FILE_PATTERN;
...
class LogBackHelper {
    ...
    private static final Logger tracer = LoggerFactory.getLogger("com.github.tools.trace");
