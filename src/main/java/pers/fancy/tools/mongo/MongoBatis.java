...
import static pers.fancy.tools.mongo.TableConstant.ID;
import static pers.fancy.tools.mongo.TableConstant.SERIAL_VERSION_ID;
...
public class MongoBatis<T extends MBaseModel> {
    ...
    private T findByIdWithCheck(long id, String collection) {
        ...
        return Optional
                .ofNullable(data)
                .orElseThrow(() -> new RuntimeException("RESOURCE_EMPTYcould not find id:[{}] in:[{}]  id, collection"));
    }
    ...
    private T findOne(Map<String, Object> where, String collection) {
        Query queryParam = BatisUtils.mapToQueryParam(where);
    ...
    private long count(Map<String, Object> where, String collection) {
        Query query = BatisUtils.mapToQueryParam(where);
    ...
    private long insert(T object, String collection) {
        BatisUtils.insertInit(object, collection, sequenceDAO);
    ...
    private WriteResult updateOne(Map<String, Object> where, Map<String, Object> update, String collection) {
        Query queryParam = BatisUtils.mapToQueryParam(where);
        Update updateParam = BatisUtils.mapToUpdateParam(update, ID, SERIAL_VERSION_ID);
    ...
    public WriteResult updateById(T object) {
        Map<String, Object> update = BatisUtils.beanToMap(object, ID, SERIAL_VERSION_ID);
    ...
    private WriteResult updateById(Map<String, Object> update, long id, String collection) {
        ...
        Update updateParam = BatisUtils.mapToUpdateParam(update);
    ...
    private WriteResult removeById(long id, String collection) {
        Query query = BatisUtils.mapToQueryParam(ImmutableMap.of("_id", id));
    ...
    private List<T> distinct(String key, DBObject query, String collection) {
        ...
        BatisUtils.checkCommandSuccess(result);
