package pers.fancy.tools.scheduler;
...
import static pers.fancy.tools.scheduler.ScheduleTask.SCHEDULE_TASK_LOGGER;
...
public class TaskScheduler implements ApplicationContextAware, DisposableBean {
    ...
    private static final String group = "com.github.tools.scheduler:TaskScheduler";
