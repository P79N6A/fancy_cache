...
public class HBaseBatis<T extends HBaseMode> {
    ...
    public HBaseBatis(String defaultFamily, HbaseTemplate hbaseTemplate, ISerializer serializer) {
        ...
        this.tableName = HBaseHelper.getTableName(type);
        this.defaultFamily = defaultFamily;
        this.template = hbaseTemplate;
        this.type = type;
        this.serializer = serializer;
    ...
    public void put(T obj) {
        Map<String, Map<String, Object>> qualifierMap = HBaseHelper.objToColumnMap(obj, defaultFamily);
    ...
    public void puts(List<T> objs) {
        ...
        for (T obj : objs) {
            ...
            qualifierMaps.add(HBaseHelper.objToColumnMap(obj, defaultFamily));
        }
    ...
    public T get(String rowKey) {
        ...
        return HBaseHelper.mapObject(rowKey, familyMap, objectMapper);
    }
    ...
    public List<T> gets(List<String> rowKeys) {
        ...
        return HBaseHelper.mapObject(rowKeys, maps, objectMapper);
    }
    ...
    public List<T> scan(String startRow, String stopRow) {
        ...
        return HBaseHelper.mapObject(rowKeys, familyMaps, objectMapper);
    }
