...
import pers.fancy.tools.utils.Objects2;
...
import static pers.fancy.tools.executor.AsyncJobExecutor.JobStatus.*;
...
public class AsyncJobExecutor<T> {
    ...
    protected ExecutorService getWorker() {
        return ExecutorManager.newFixedMinMaxThreadPool("com.github.tools.executor:AsyncJobExecutor", 20, 20, 1024, new ThreadPoolExecutor.AbortPolicy());
    }
