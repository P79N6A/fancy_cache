...
public class KeyGenerator {
    ...
    public static String generateSingleKey(CacheAnnoHolder cacheXAnnoHolder, Object[] argValues) {
    ...
    public static Map[] generateMultiKey(CacheAnnoHolder cacheXAnnoHolder, Object[] argValues) {
